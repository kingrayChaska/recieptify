...
export const MinimalTemplate = ({
  ...
  return (
    <div
      className="bg-white text-gray-900 w-full rounded-xl font-sans border"
    ...
    >
      ...
      <div className="px-6 py-4 space-y-4">
        ...
        <div
          className="border-t border-dashed pt-3 space-y-1 text-sm"
          style={{ borderColor: accentColor }}
        >
        ...
        <p className="text-center text-[10px] text-gray-300">Invoice.Me</p>
      </div>
    </div>
  );
};
