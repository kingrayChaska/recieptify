...
export default function LoginPage() {
  ...
  const handleOAuth = async (provider: "google" | "github") => {
    ...
    // On success the browser navigates away to the provider, so we only
    ...
    <div className="min-h-screen bg-base flex items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-in">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/auth/reset-password" className="text-xs text-muted hover:text-[var(--brand)] transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
        ...
        <p className="text-center text-xs text-muted mt-5">
          ...
          <Link href="/auth/register" className="text-[var(--brand)] font-semibold hover:underline">
            Sign up
          </Link>
        </p>
      </div>
